			...
			<div class="row grid">
				...
				<div class="col-xs-12 col-sm-6 item grid-sizer design">
					<div class="project_content">
						<div class="my__img">
							<img src="<?php echo get_template_directory_uri(); ?>/assets/images/portfolio/work-1.jpg" alt=''>
						</div>
						<div class="info">
								...
								<div class="col-sm-6">
									...
									<div class="project__slider">
										<ul class="project-slider">
											...
											<!-- image 1 -->
											<li>
												<img src="<?php echo get_template_directory_uri(); ?>/assets/images/portfolio/work-2.jpg" alt="">
											</li>

											<!-- image 2 -->
											<li>
												<img src="<?php echo get_template_directory_uri(); ?>/assets/images/portfolio/work-3.jpg" alt="">
											</li>

											<!-- image 3 -->
											<li>
												<img src="<?php echo get_template_directory_uri(); ?>/assets/images/portfolio/work-4.jpg" alt="">
											</li>
									...
									<img src="<?php echo get_template_directory_uri(); ?>/assets/images/portfolio/work-5.jpg" alt="" class="margin-top-45">
				...
				<div class="col-xs-12 col-sm-6 item coding">
					<div class="project_content">
						<div class="my_img" data-mfp-src="<?php echo get_template_directory_uri(); ?>/assets/images/portfolio/work-2.jpg">
							<img src="<?php echo get_template_directory_uri(); ?>/assets/images/portfolio/work-2.jpg" alt=''>
						</div>
						<div class="info">
							<div class="display-table">
				...
				<div class="col-xs-12 col-sm-6 item logo">
					<div class="project_content">
						<div class="my__img">
							<img src="<?php echo get_template_directory_uri(); ?>/assets/images/portfolio/work-5.jpg" alt=''>
						</div>
						<div class="info">
							<div class="display-table">
								<div class="display-table-cell">
				...
				<div class="col-xs-12 col-sm-6 item coding">
					<div class="project_content">
						<div class="my_img" data-mfp-src="<?php echo get_template_directory_uri(); ?>/assets/images/portfolio/work-6.jpg">
							<img src="<?php echo get_template_directory_uri(); ?>/assets/images/portfolio/work-6.jpg" alt=''>
						</div>
						<div class="info">
							<div class="display-table">
								<div class="display-table-cell">
